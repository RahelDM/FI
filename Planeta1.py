...
cuadrado= pygame.Rect(90,470,40,40) # crear un rectángulo
x=0
y=0
...
#Música de fondo:
musicaFondo=pygame.mixer.Sound("Música/Música1.mp3") #Cargamos la música.
...
#                    ---------- COLISIONES ----------
    ...
    if colisionesMonedas:
        monedas=monedas+5 # Cada moneda tendrá el valor de 5 puntos.
        monedaSonido.play()
...
#                    ---------- ZONA DE DIBUJO ----------
    ...
    if monedas==50:
        Planeta2.planeta2()
    clock.tick(60)
    Funciones.dibujarMapa(pantalla,listaMuros)# Se dibujan los rectángulos en la pantalla
